...
#Maximum number of milliseconds provide for IF_DB lock
export PFE_CFG_IF_DB_MAX_LOCK_TIME?=1000
#Number of milliseconds for IF_DB polled_lock
export PFE_CFG_IF_DB_POLLING_LOCK_TIME?=1000
#Maximum time in milliseconds for PFE Slave to retry lock of IF_DB
export PFE_CFG_IF_DB_RPC_RETRY_LOCK_TIME?=200
...
#Enable connecting to PHY by slave driver
export PFE_CFG_PFE_SLAVE_PHY?=0
...
ifneq ($(PFE_CFG_PFE_SLAVE_PHY),0)
    GLOBAL_CCFLAGS+=-DPFE_CFG_PFE_SLAVE_PHY
endif
endif
...
ifneq ($(PFE_CFG_IF_DB_MAX_LOCK_TIME),0)
  GLOBAL_CCFLAGS+=-DPFE_CFG_IF_DB_MAX_LOCK_TIME='$(PFE_CFG_IF_DB_MAX_LOCK_TIME)'
endif

ifneq ($(PFE_CFG_IF_DB_POLLING_LOCK_TIME),0)
  GLOBAL_CCFLAGS+=-DPFE_CFG_IF_DB_POLLING_LOCK_TIME='$(PFE_CFG_IF_DB_POLLING_LOCK_TIME)'
endif

ifneq ($(PFE_CFG_IF_DB_RPC_RETRY_LOCK_TIME),0)
  GLOBAL_CCFLAGS+=-DPFE_CFG_IF_DB_RPC_RETRY_LOCK_TIME='$(PFE_CFG_IF_DB_RPC_RETRY_LOCK_TIME)'
endif
...
#    export PFE_CFG_TARGET_ARCH_DEF=PFE_CFG_TARGET_ARCH_$(shell echo $(PLATFORM) | cut -d '-' -f 1-1)
    export PFE_CFG_TARGET_ARCH_DEF=PFE_CFG_TARGET_ARCH_aarch64
    export PFE_CFG_TARGET_OS_DEF=PFE_CFG_TARGET_OS_$(TARGET_OS)
    export PFE_CFG_BUILD_PROFILE_DEF:=PFE_CFG_BUILD_PROFILE_$(shell echo $(BUILD_PROFILE) | tr [a-z] [A-Z])
